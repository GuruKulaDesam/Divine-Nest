...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-yellow-50 dark:from-gray-900 dark:via-red-900/20 dark:to-orange-900/20"><div class="container mx-auto px-4 py-8"><div class="mb-8"><div class="flex items-center justify-between mb-6"><div class="flex items-center space-x-3"><div class="p-3 bg-gradient-to-br from-red-500 to-orange-500 rounded-xl text-white">`);
    Icon($$renderer2, { icon: "heroicons:book-open", class: "w-8 h-8" });
    $$renderer2.push(`<!----></div> <div><h1 class="text-3xl font-bold text-gray-900 dark:text-white">Traditional Tamil Recipes</h1> <p class="text-gray-600 dark:text-gray-300">पाकशास्त्रम् | The sacred art of cooking with love and tradition</p></div></div></div> <div class="bg-gradient-to-r from-red-500 to-orange-500 rounded-2xl p-6 text-white mb-6"><div class="flex items-center space-x-4">`);
    Icon($$renderer2, { icon: "heroicons:fire", class: "w-12 h-12 text-white/80" });
    $$renderer2.push(`<!----> <div><h3 class="text-xl font-bold mb-2">रसोई संस्कार | Kitchen Traditions</h3> <p class="text-white/90">"अन्नं ब्रह्म रसो विष्णु पक्ता देवो महेश्वर: | Food is Brahma, taste is Vishnu, and the cook is Maheshwara. Every recipe carries generations of love, wisdom, and cultural heritage."</p> <p class="text-sm text-white/70 mt-2">Tamil: "சமையல் கலை என்பது அன்பும் பாரம்பரியமும் கலந்த புனித கலை"</p></div></div></div> <div class="mb-6"><div class="relative">`);
    Icon($$renderer2, {
      icon: "heroicons:magnifying-glass",
      class: "absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5"
    });
    $$renderer2.push(`<!----> <input type="text"${attr("value", searchTerm)} placeholder="Search recipes, ingredients, or emotions..." class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-transparent dark:bg-gray-800 dark:border-gray-600 dark:text-white"/></div></div></div> <div class="flex flex-wrap gap-2 mb-6"><!--[-->`);
    const each_array = ensure_array_like(tabs);
    for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
      let tab = each_array[$$index];
      $$renderer2.push(`<button${attr_class(`flex items-center space-x-2 px-4 py-2 rounded-lg transition-all duration-200 ${stringify(currentTab === tab.id ? "bg-red-500 text-white shadow-lg" : "bg-white/80 text-gray-700 hover:bg-red-100 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-red-900/20")}`)}>`);
      Icon($$renderer2, { icon: tab.icon, class: "w-4 h-4" });
      $$renderer2.push(`<!----> <span class="font-medium">${escape_html(tab.label)}</span></button>`);
    }
    $$renderer2.push(`<!--]--></div> <div class="mb-6"><p class="text-gray-600 dark:text-gray-400">Showing ${escape_html(getFilteredRecipes().length)} traditional recipes `);
    {
      $$renderer2.push("<!--[!-->");
    }
    $$renderer2.push(`<!--]--></p></div> <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"><!--[-->`);
    const each_array_1 = ensure_array_like(getFilteredRecipes());
    for (let $$index_2 = 0, $$length = each_array_1.length; $$index_2 < $$length; $$index_2++) {
      let recipe = each_array_1[$$index_2];
      $$renderer2.push(`<div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-300 border border-orange-200 dark:border-orange-700"><div class="flex items-start justify-between mb-4"><div><h3 class="text-lg font-bold text-gray-900 dark:text-white mb-1">${escape_html(recipe.name)}</h3> <div class="flex items-center space-x-2 mb-2"><span${attr_class(`px-2 py-1 text-xs font-medium rounded-full ${stringify(getDifficultyColor(recipe.difficulty))}`)}>${escape_html(recipe.difficulty)}</span> <span${attr_class(`px-2 py-1 text-xs font-medium rounded-full ${stringify(getCategoryColor(recipe.category))}`)}>${escape_html(recipe.category)}</span></div></div> <button class="p-2 rounded-full hover:bg-red-100 dark:hover:bg-red-900/20 transition-colors"${attr("disabled", isFavorite(recipe), true)}>`);
      Icon($$renderer2, {
        icon: isFavorite(recipe) ? "heroicons:heart-solid" : "heroicons:heart",
        class: `w-5 h-5 ${stringify(isFavorite(recipe) ? "text-red-500" : "text-gray-400")}`
      });
      $$renderer2.push(`<!----></button></div> <div class="space-y-3 mb-4"><div class="flex items-center justify-between text-sm"><span class="text-gray-600 dark:text-gray-400 flex items-center">`);
      Icon($$renderer2, { icon: "heroicons:clock", class: "w-4 h-4 mr-1" });
      $$renderer2.push(`<!----> Prep Time:</span> <span class="font-medium">${escape_html(recipe.prep_time)}</span></div> <div class="flex items-center justify-between text-sm"><span class="text-gray-600 dark:text-gray-400 flex items-center">`);
      Icon($$renderer2, { icon: "heroicons:users", class: "w-4 h-4 mr-1" });
      $$renderer2.push(`<!----> Serves:</span> <span class="font-medium">${escape_html(recipe.serves)}</span></div></div> <div class="mb-4"><h4 class="font-semibold text-gray-900 dark:text-white mb-2 flex items-center">`);
      Icon($$renderer2, {
        icon: "heroicons:square-3-stack-3d",
        class: "w-4 h-4 mr-2 text-orange-500"
      });
      $$renderer2.push(`<!----> Ingredients</h4> <div class="flex flex-wrap gap-1"><!--[-->`);
      const each_array_2 = ensure_array_like(recipe.ingredients);
      for (let $$index_1 = 0, $$length2 = each_array_2.length; $$index_1 < $$length2; $$index_1++) {
        let ingredient = each_array_2[$$index_1];
        $$renderer2.push(`<span class="px-2 py-1 text-xs bg-orange-100 dark:bg-orange-900/20 text-orange-800 dark:text-orange-200 rounded-full">${escape_html(ingredient)}</span>`);
      }
      $$renderer2.push(`<!--]--></div></div> <div class="mb-4"><h4 class="font-semibold text-gray-900 dark:text-white mb-2 flex items-center">`);
      Icon($$renderer2, {
        icon: "heroicons:list-bullet",
        class: "w-4 h-4 mr-2 text-blue-500"
      });
      $$renderer2.push(`<!----> Method</h4> <p class="text-sm text-gray-600 dark:text-gray-400">${escape_html(recipe.method)}</p></div> <div class="mb-4 p-3 bg-gradient-to-r from-pink-50 to-purple-50 dark:from-pink-900/20 dark:to-purple-900/20 rounded-lg"><h4 class="font-semibold text-pink-900 dark:text-pink-100 mb-1 flex items-center">`);
      Icon($$renderer2, { icon: "heroicons:heart", class: "w-4 h-4 mr-2" });
      $$renderer2.push(`<!----> Family Memory</h4> <p class="text-sm text-pink-800 dark:text-pink-200 italic">"${escape_html(recipe.emotion)}"</p></div> `);
      if (recipe.health_benefits) {
        $$renderer2.push("<!--[-->");
        $$renderer2.push(`<div class="p-3 bg-green-50 dark:bg-green-900/20 rounded-lg"><h4 class="font-semibold text-green-900 dark:text-green-100 mb-1 flex items-center">`);
        Icon($$renderer2, { icon: "heroicons:heart", class: "w-4 h-4 mr-2" });
        $$renderer2.push(`<!----> Health Benefits</h4> <p class="text-sm text-green-800 dark:text-green-200">${escape_html(recipe.health_benefits)}</p></div>`);
      } else {
        $$renderer2.push("<!--[!-->");
      }
      $$renderer2.push(`<!--]--> <div class="flex space-x-2 mt-4"><button class="flex-1 bg-orange-500 text-white px-4 py-2 rounded-lg hover:bg-orange-600 transition-colors text-sm font-medium">Cook This</button> <button class="bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-4 py-2 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors text-sm">Share</button></div></div>`);
    }
    $$renderer2.push(`<!--]--></div> `);
    if (getFilteredRecipes().length === 0) {
      ...
      $$renderer2.push(`<!----> <h3 class="text-xl font-semibold text-gray-700 dark:text-gray-300 mb-2">No Recipes Found</h3> <p class="text-gray-500 dark:text-gray-400 mb-4">`);
      {
        $$renderer2.push("<!--[!-->");
        $$renderer2.push(`No recipes available in this category`);
      }
      $$renderer2.push(`<!--]--></p> `);
      {
        $$renderer2.push("<!--[!-->");
    ...
    $$renderer2.push(`<!--]--> <div class="mt-12 p-6 bg-gradient-to-r from-amber-100 to-orange-100 dark:from-amber-900/30 dark:to-orange-900/30 rounded-xl"><h4 class="font-bold text-amber-800 dark:text-amber-200 mb-4 flex items-center">`);
    Icon($$renderer2, { icon: "heroicons:star", class: "w-5 h-5 mr-2" });
    $$renderer2.push(`<!----> पाकशास्त्र ज्ञान | Culinary Wisdom</h4> <div class="grid grid-cols-1 md:grid-cols-2 gap-4"><div><h5 class="font-semibold text-amber-700 dark:text-amber-300 mb-2">Cooking Philosophy:</h5> <ul class="text-sm text-amber-700 dark:text-amber-300 space-y-1"><li>• Cook with devotion - food absorbs the cook's emotions</li> <li>• Use fresh, seasonal ingredients from nature</li> <li>• Balance the six tastes in every meal</li> <li>• Feed others before feeding yourself</li></ul></div> <div><h5 class="font-semibold text-amber-700 dark:text-amber-300 mb-2">Kitchen Mantras:</h5> <ul class="text-sm text-amber-700 dark:text-amber-300 space-y-1"><li>• "अन्नदानं महादानं" - Giving food is the greatest charity</li> <li>• Clean kitchen, pure heart, blessed food</li> <li>• Waste not, want not - respect every grain</li> <li>• Share recipes, spread love and culture</li></ul></div></div> <blockquote class="mt-4 p-3 bg-amber-200 dark:bg-amber-800 rounded-lg italic text-amber-800 dark:text-amber-200">"यत्पिण्डे तत्ब्रह्माण्डे | As is the individual, so is the universe. What we cook and eat shapes not just our body, but our mind and spirit."</blockquote></div></div></div>`);
  });
}
export {
  _page as default
