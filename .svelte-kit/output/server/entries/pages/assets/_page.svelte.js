...
function AssetsPage($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<!----></div> <div><h1 class="text-3xl font-bold text-gray-900">Family Asset Management Suite</h1> <p class="text-lg text-gray-600">குடும்ப சொத்து மேலாண்மை தொகுப்பு</p> <p class="text-sm text-gray-500">Comprehensive asset tracking for South Indian families</p></div></div> <div class="flex space-x-6"><div class="text-center"><div class="text-2xl font-bold text-purple-600">156</div> <div class="text-sm text-gray-500">Total Assets</div></div> <div class="text-center"><div class="text-2xl font-bold text-green-600">₹${escape_html(
      // Asset Sections for navigation
      totalValue.toLocaleString()
    )}</div> <div class="text-sm text-gray-500">Total Value</div></div> <div class="text-center"><div class="text-2xl font-bold text-orange-600">8</div> <div class="text-sm text-gray-500">Pending Service</div></div></div></div> <div class="flex flex-wrap gap-2"><!--[-->`);
    const each_array = ensure_array_like(AssetSections);
    for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
      let section = each_array[$$index];
      $$renderer2.push(`<button${attr_class(`flex items-center space-x-2 px-4 py-2 rounded-lg transition-all ${stringify(activeSection === section.id ? "bg-purple-500 text-white shadow-md" : "bg-gray-100 text-gray-700 hover:bg-gray-200")}`)}>`);
    ...
    $$renderer2.push(`<!--]--></div></div></div></div> <div class="space-y-6"><div class="flex items-center justify-between mb-8"><div class="flex items-center space-x-4"><div class="p-3 bg-gradient-to-br from-blue-500 to-green-500 rounded-xl text-white shadow-lg">`);
    ...
    if (currentSection === "overview") {
      ...
      const each_array_2 = ensure_array_like(assetCategories);
      ...
      const each_array_3 = ensure_array_like(recentActivity);
      ...
      const each_array_4 = ensure_array_like(upcomingTasks);
      ...
      $$renderer2.push("<!--[!-->");
      $$renderer2.push(`<div class="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-sm border border-gray-200 dark:border-gray-700"><div class="text-center"><div class="p-4 bg-blue-100 dark:bg-blue-900/30 rounded-full w-16 h-16 mx-auto mb-4">`);
      Icon($$renderer2, {
        icon: sections.find((s) => s.id === currentSection)?.icon || "heroicons:squares-2x2",
        class: "w-8 h-8 text-blue-600 dark:text-blue-400"
      });
      $$renderer2.push(`<!----></div> <h3 class="text-2xl font-bold text-gray-900 dark:text-white mb-2">${escape_html(sections.find((s) => s.id === currentSection)?.label)}</h3> <p class="text-gray-600 dark:text-gray-400 mb-6">This section is under development and will include comprehensive management tools.</p> `);
      if (currentSection === "items") {
        $$renderer2.push("<!--[-->");
        $$renderer2.push(`<div class="text-left max-w-2xl mx-auto space-y-4"><h4 class="font-semibold text-gray-900 dark:text-white">Will include:</h4> <ul class="text-sm text-gray-600 dark:text-gray-400 space-y-2"><li>• Complete asset inventory with photos and descriptions</li> <li>• Purchase details, warranty information, and current value</li> <li>• Location tracking within your home</li> <li>• Integration with existing vehicle and inventory systems</li> <li>• Smart categorization and search functionality</li></ul></div>`);
      } else {
        $$renderer2.push("<!--[!-->");
        if (currentSection === "documents") {
          $$renderer2.push("<!--[-->");
          $$renderer2.push(`<div class="text-left max-w-2xl mx-auto space-y-4"><h4 class="font-semibold text-gray-900 dark:text-white">Will include:</h4> <ul class="text-sm text-gray-600 dark:text-gray-400 space-y-2"><li>• Digital storage of bills, warranties, and ownership proofs</li> <li>• Automatic expiry alerts and renewal reminders</li> <li>• Document scanning and OCR capabilities</li> <li>• Secure cloud backup and access controls</li></ul></div>`);
        } else {
          $$renderer2.push("<!--[!-->");
          if (currentSection === "maintenance") {
            $$renderer2.push("<!--[-->");
            $$renderer2.push(`<div class="text-left max-w-2xl mx-auto space-y-4"><h4 class="font-semibold text-gray-900 dark:text-white">Will include:</h4> <ul class="text-sm text-gray-600 dark:text-gray-400 space-y-2"><li>• Automated maintenance schedules and reminders</li> <li>• Service history and vendor management</li> <li>• Cost tracking and budget planning</li> <li>• Performance monitoring and replacement suggestions</li></ul></div>`);
          } else {
            $$renderer2.push("<!--[!-->");
            if (currentSection === "heirlooms") {
              $$renderer2.push("<!--[-->");
              $$renderer2.push(`<div class="text-left max-w-2xl mx-auto space-y-4"><h4 class="font-semibold text-gray-900 dark:text-white">Will include:</h4> <ul class="text-sm text-gray-600 dark:text-gray-400 space-y-2"><li>• Emotional significance and family stories</li> <li>• Cultural and ritual importance tracking</li> <li>• Preservation tips and care instructions</li> <li>• Legacy planning and inheritance preparation</li></ul></div>`);
            } else {
              $$renderer2.push("<!--[!-->");
            }
            $$renderer2.push(`<!--]-->`);
