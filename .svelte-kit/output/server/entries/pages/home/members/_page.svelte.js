...
function MembersPage($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`</div> <div class="form-control"><button class="btn btn-outline btn-block">Clear Filters</button></div></div></div></div> <div class="card bg-base-100 shadow-lg"><div class="card-body p-0">`);
    if (store_get($$store_subs ??= {}, "$filteredMembers", filteredMembers).length === 0) {
      ...
      for (let $$index_2 = 0, $$length = each_array_2.length; $$index_2 < $$length; $$index_2++) {
        ...
        $$renderer2.push(`<!----></button> <ul class="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52"><li><button class="btn btn-ghost">Edit</button></li> <li><button class="btn btn-ghost text-error">Delete</button></li></ul></div></td></tr>`);
      }
