...
function _page($$renderer) {
  head($$renderer, ($$renderer2) => {
    $$renderer2.title(($$renderer3) => {
      $$renderer3.push(`<title>Rituals &amp; Spiritual Life - South Indian Family App</title>`);
    });
    $$renderer2.push(`<meta name="description" content="Manage daily rituals, temple trips, and festival celebrations in your South Indian family life"/>`);
  });
