import { b as attr_class, d as attr, c as store_get, a as ensure_array_like, s as stringify, j as attr_style, u as unsubscribe_stores } from "./index2.js";
import "./dexie-db.js";
...
function RemindersPage($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    $$renderer2.push(`<div class="reminders-page min-h-screen mountain-background p-6 svelte-tnd5ji"><div class="max-w-6xl mx-auto"><div class="text-center mb-8"><h1 class="text-4xl font-bold text-white mb-2 flex items-center justify-center gap-3"><span class="text-5xl">🔔</span> Smart Reminders</h1> <p class="text-white/70 text-lg">AI-powered reminders generated from your notes and calendar</p></div> <div class="flex justify-center mb-6 gap-4"><button${attr_class(`btn btn-primary btn-lg shadow-xl hover:shadow-2xl transition-all duration-300 ${stringify("")}`, "svelte-tnd5ji")}${attr("disabled", isGenerating, true)}>`);
    {
      $$renderer2.push("<!--[!-->");
