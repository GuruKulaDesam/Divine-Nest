import { h as head, c as store_get, b as attr_class, a as ensure_array_like, s as stringify, u as unsubscribe_stores, j as attr_style, d as attr } from "./index2.js";
...
function SchedulePage($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    if (showEventModal && selectedEvent) {
      $$renderer2.push("<!--[-->");
      $$renderer2.push(`<div class="modal modal-open"><div class="modal-box w-11/12 max-w-md svelte-1uqqeqg"><button class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button> <div class="space-y-6"><div class="flex items-start gap-3"><div class="w-4 h-4 rounded-full mt-1"${attr_style(`background-color: ${stringify(selectedEvent.color)}`)}></div> <div class="flex-1"><h3 class="text-xl font-bold text-base-content">${escape_html(selectedEvent.title)}</h3> `);
