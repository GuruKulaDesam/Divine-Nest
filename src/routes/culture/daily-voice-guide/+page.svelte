  ...
  <div class="max-w-7xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-8">
      <div class="text-center flex-1">
        <h1 class="text-5xl font-bold text-gray-800 mb-2">🎙️ தினசரி ஒலி வழிகாட்டி</h1>
        <p class="text-xl text-gray-600">Daily Voice Guide – 30 Days of Tamil Living</p>
        <p class="text-lg text-amber-700 italic mt-2">Shivo's Gentle Voice for Your Soul</p>
      </div>
    ...
    <div class="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/50 mb-8 transform hover:scale-105 transition-all duration-300">
      <div class="text-center">
        ...
        <h2 class="text-3xl font-bold text-gray-800 mb-4">Shivo Daily Voice Guide</h2>
        <p class="text-lg text-gray-700 mb-6">A 30-day journey of Tamil wisdom, delivered in the loving voices of your family. Each day brings one lesson, one reflection, and one practice—spoken with the gentle warmth of Paati, Amma, Appa, and your inner child.</p>
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
          <div class="bg-gradient-to-br from-purple-100 to-purple-200 rounded-xl p-4 text-center">
            <Icon icon="heroicons:user-circle" class="w-8 h-8 text-purple-600 mx-auto mb-2" />
            <div class="font-semibold text-purple-800">Paati</div>
            <div class="text-sm text-purple-600">Wise & Gentle</div>
          </div>
          <div class="bg-gradient-to-br from-pink-100 to-pink-200 rounded-xl p-4 text-center">
            ...
            <div class="font-semibold text-pink-800">Amma</div>
            <div class="text-sm text-pink-600">Nurturing & Warm</div>
          </div>
          <div class="bg-gradient-to-br from-blue-100 to-blue-200 rounded-xl p-4 text-center">
            <Icon icon="heroicons:shield-check" class="w-8 h-8 text-blue-600 mx-auto mb-2" />
            <div class="font-semibold text-blue-800">Appa</div>
            <div class="text-sm text-blue-600">Firm & Guiding</div>
          </div>
          <div class="bg-gradient-to-br from-green-100 to-green-200 rounded-xl p-4 text-center">
            <Icon icon="heroicons:academic-cap" class="w-8 h-8 text-green-600 mx-auto mb-2" />
            <div class="font-semibold text-green-800">Child</div>
            <div class="text-sm text-green-600">Curious & Playful</div>
          </div>
        </div>
      </div>
    </div>
    ...
    <!-- Days 1-5 -->
    <div class="mb-12">
      <h2 class="text-4xl font-bold text-center text-gray-800 mb-8">🌅 Days 1-5: Foundation</h2>
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {#each voiceGuideData.slice(0, 5) as day}
          <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/50 transform hover:scale-105 transition-all duration-300">
            <div class="flex items-center space-x-3 mb-4">
              <div class="w-12 h-12 bg-gradient-to-br {getSpeakerColor(day.speaker)} rounded-xl flex items-center justify-center shadow-lg">
                <Icon icon={getSpeakerIcon(day.speaker)} class="w-6 h-6 text-white" />
              </div>
              <div>
                <h3 class="text-xl font-bold text-gray-800">Day {day.day}</h3>
                <p class="text-sm text-gray-600">{day.englishTitle}</p>
              </div>
            </div>
            <div class="mb-3">
              <span class="inline-block bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-sm font-medium">
                🗣️ {day.voice} • {day.speaker}
              </span>
            </div>
            <p class="text-gray-700 italic leading-relaxed">"{day.content}"</p>
          </div>
        {/each}
      </div>
    </div>
    ...
    <!-- Days 6-10 -->
    <div class="mb-12">
      <h2 class="text-4xl font-bold text-center text-gray-800 mb-8">🌿 Days 6-10: Growth</h2>
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {#each voiceGuideData.slice(5, 10) as day}
          <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/50 transform hover:scale-105 transition-all duration-300">
            <div class="flex items-center space-x-3 mb-4">
              <div class="w-12 h-12 bg-gradient-to-br {getSpeakerColor(day.speaker)} rounded-xl flex items-center justify-center shadow-lg">
                <Icon icon={getSpeakerIcon(day.speaker)} class="w-6 h-6 text-white" />
    ...
    <!-- Days 11-15 -->
    <div class="mb-12">
      <h2 class="text-4xl font-bold text-center text-gray-800 mb-8">🧘 Days 11-15: Reflection</h2>
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {#each voiceGuideData.slice(10, 15) as day}
          <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/50 transform hover:scale-105 transition-all duration-300">
            <div class="flex items-center space-x-3 mb-4">
              <div class="w-12 h-12 bg-gradient-to-br {getSpeakerColor(day.speaker)} rounded-xl flex items-center justify-center shadow-lg">
                <Icon icon={getSpeakerIcon(day.speaker)} class="w-6 h-6 text-white" />
    ...
    <!-- Days 16-20 -->
    <div class="mb-12">
      <h2 class="text-4xl font-bold text-center text-gray-800 mb-8">🎨 Days 16-20: Expression</h2>
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {#each voiceGuideData.slice(15, 20) as day}
          <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/50 transform hover:scale-105 transition-all duration-300">
            <div class="flex items-center space-x-3 mb-4">
              <div class="w-12 h-12 bg-gradient-to-br {getSpeakerColor(day.speaker)} rounded-xl flex items-center justify-center shadow-lg">
                <Icon icon={getSpeakerIcon(day.speaker)} class="w-6 h-6 text-white" />
    ...
    <!-- Days 21-25 -->
    <div class="mb-12">
      <h2 class="text-4xl font-bold text-center text-gray-800 mb-8">🌟 Days 21-25: Mastery</h2>
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {#each voiceGuideData.slice(20, 25) as day}
          <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/50 transform hover:scale-105 transition-all duration-300">
            <div class="flex items-center space-x-3 mb-4">
              <div class="w-12 h-12 bg-gradient-to-br {getSpeakerColor(day.speaker)} rounded-xl flex items-center justify-center shadow-lg">
                <Icon icon={getSpeakerIcon(day.speaker)} class="w-6 h-6 text-white" />
    ...
    <!-- Days 26-30 -->
    <div class="mb-12">
      <h2 class="text-4xl font-bold text-center text-gray-800 mb-8">🎉 Days 26-30: Completion</h2>
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {#each voiceGuideData.slice(25, 30) as day}
          <div class="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-white/50 transform hover:scale-105 transition-all duration-300">
            <div class="flex items-center space-x-3 mb-4">
              <div class="w-12 h-12 bg-gradient-to-br {getSpeakerColor(day.speaker)} rounded-xl flex items-center justify-center shadow-lg">
                <Icon icon={getSpeakerIcon(day.speaker)} class="w-6 h-6 text-white" />
    ...
    <div class="bg-gradient-to-r from-amber-100 via-orange-100 to-red-100 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-amber-200 mb-8 transform hover:scale-105 transition-all duration-300">
      <div class="text-center">
        ...
        <h2 class="text-4xl font-bold text-gray-800 mb-4">30 Days Complete! 🌟</h2>
        <p class="text-xl text-gray-700 mb-6">You have journeyed through 30 days of Tamil wisdom, guided by the loving voices of your family. Each day brought a lesson, a reflection, and a practice—spoken with the gentle warmth that connects generations.</p>
        <p class="text-lg text-amber-800 italic mb-6">"பழமையை கற்றுக்கொள், நிகழ்காலத்தில் வாழ், எதிர்காலத்தை கட்டமை செய்"</p>
        <p class="text-lg text-gray-700">Ready to begin again? Your Tamil soul knows the way. 🕉️</p>
      </div>
    </div>

    <!-- Navigation -->
    <div class="text-center">
      <button on:click={navigateBack} class="bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white px-8 py-4 rounded-2xl font-bold text-xl shadow-xl transform hover:scale-105 transition-all duration-300">
        <Icon icon="heroicons:arrow-left" class="w-6 h-6 mr-2 inline" />
        Back to Wisdom Menu
      </button>
    </div>
  </div>
