<script>
  ...
  import { expenseCategories, monthlyBudget, expenseHistory, subscriptions, propertyTaxes, calculateMonthlyAverage, getUpcomingRenewals, getPendingTaxes } from "$lib/data/expenses.js";
