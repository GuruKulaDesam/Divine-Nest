  ...
  <div class="border-b border-gray-200 pb-6" use:motionInView={{ animation: 'fadeInDown' }}>
    <div class="flex items-center justify-between">
      <div>
        ...
        <p class="mt-2 text-sm text-gray-600">{$_("settings.description")}</p>
      </div>
  ...
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
    ...
    <div class="lg:col-span-2 space-y-6">
      ...
      <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6" use:motionInView={{ animation: 'fadeInLeft' }}>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">{$_("settings.full_name")}</label>
            <input
              type="text"
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">{$_("settings.email_address")}</label>
            <input
              type="email"
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">{$_("settings.role")}</label>
            <input
              type="text"
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">{$_("settings.timezone")}</label>
            <div class="relative">
              <button 
      ...
      <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6" use:motionInView={{ animation: 'fadeInLeft' }}>
        ...
        <div class="space-y-4">
          <div class="flex items-center justify-between">
            <div>
              <h3 class="text-sm font-medium text-gray-900">{$_("settings.email_notifications")}</h3>
              <p class="text-sm text-gray-500">{$_("settings.email_notifications_desc")}</p>
            </div>
          ...
          <div class="flex items-center justify-between">
            <div>
              <h3 class="text-sm font-medium text-gray-900">{$_("settings.push_notifications")}</h3>
              <p class="text-sm text-gray-500">{$_("settings.push_notifications_desc")}</p>
            </div>
            <label class="relative inline-flex items-center cursor-pointer">
          ...
          <div class="flex items-center justify-between">
            <div>
              <h3 class="text-sm font-medium text-gray-900">{$_("settings.marketing_emails")}</h3>
              <p class="text-sm text-gray-500">{$_("settings.marketing_emails_desc")}</p>
            </div>
            <label class="relative inline-flex items-center cursor-pointer">
          ...
          <div class="flex items-center justify-between">
            <div>
              <h3 class="text-sm font-medium text-gray-900">{$_("settings.security_alerts")}</h3>
              <p class="text-sm text-gray-500">{$_("settings.security_alerts_desc")}</p>
            </div>
            <label class="relative inline-flex items-center cursor-pointer">
      ...
      <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6" use:motionInView={{ animation: 'fadeInLeft' }}>
        ...
        <div class="space-y-6">
          <div class="flex items-center justify-between">
            <div>
              <h3 class="text-sm font-medium text-gray-900">{$_("settings.two_factor_auth")}</h3>
              <p class="text-sm text-gray-500">{$_("settings.two_factor_auth_desc")}</p>
            </div>
            <label class="relative inline-flex items-center cursor-pointer">
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">{$_("settings.session_timeout")}</label>
            <select
          ...
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">{$_("settings.password_expiry")}</label>
            <select
    ...
    <div class="space-y-6">
      <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6" use:motionInView={{ animation: 'fadeInRight' }}>
        ...
        <div class="space-y-4">
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-2">{$_("settings.theme")}</label>
            <div class="relative">
              <button 
                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-left bg-white"
          ...
          <div class="flex items-center justify-between">
            <div>
              <h3 class="text-sm font-medium text-gray-900">{$_("settings.compact_mode")}</h3>
              <p class="text-sm text-gray-500">{$_("settings.compact_mode_desc")}</p>
            </div>
            <label class="relative inline-flex items-center cursor-pointer">
          ...
          <div class="flex items-center justify-between">
            <div>
              <h3 class="text-sm font-medium text-gray-900">{$_("settings.show_animations")}</h3>
              <p class="text-sm text-gray-500">{$_("settings.show_animations_desc")}</p>
            </div>
            <label class="relative inline-flex items-center cursor-pointer">
