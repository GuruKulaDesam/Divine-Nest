  ...
  <div class="max-w-md w-full relative">
    ...
    <div class="backdrop-blur-sm bg-white/90 dark:bg-gray-800/90 p-6 md:p-8 rounded-xl shadow-[0_2px_8px_-3px_rgba(0,0,0,0.1)] dark:shadow-[0_2px_8px_-3px_rgba(0,0,0,0.3)] border border-gray-100 dark:border-gray-700/50" 
      ...
      <div class="text-center mb-6">
        <h1 class="text-xl font-semibold text-gray-900 dark:text-white" use:motionInView={{ animation: 'fadeInUp', delay: 0.1 }}>{$_('auth.register')}</h1>
        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400" use:motionInView={{ animation: 'fadeInUp', delay: 0.2 }}>{$_('auth.register_description')}</p>
      </div>
      ...
      <form class="space-y-4" on:submit|preventDefault={handleSubmit}>
        ...
        <div class="flex items-start" use:motionInView={{ animation: 'fadeInUp', delay: 0.6 }}>
      ...
      <!-- Divider -->
      <div class="relative my-6" use:motionInView={{ animation: 'fadeInUp', delay: 0.8 }}>
      ...
      <!-- Sign in link -->
      <div class="text-center mt-6 text-sm" use:motionInView={{ animation: 'fadeInUp', delay: 1 }}>
