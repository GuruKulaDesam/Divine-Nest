<script>
  ...
  import FamilyMemberCard from "$lib/components/FamilyMemberCard.svelte";
  import RechargeTracker from "$lib/components/RechargeTracker.svelte";
  import ExpenseLogger from "$lib/components/ExpenseLogger.svelte";
  import BudgetDashboard from "$lib/components/BudgetDashboard.svelte";
  import { familyMembers, totalMonthlyRecharges, totalYearlyRenewals } from "$lib/data/family.js";
